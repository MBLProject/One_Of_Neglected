...
public class Skill
{
    ...
    protected float pierceDelay = 0.1f;
    ...
    protected Skill(Enums.SkillName skillName, float defaultCooldown, float pierceDelay = 0.1f, float shotDelay = 0.5f)
    {
        ...
        this.pierceDelay = pierceDelay;
        this.shotDelay = shotDelay;
    }

    public void InitSkill(float damage, int level, int pierceCount, int shotCount, int projectileCount, float pierceDelay, float shotDelay)
    {
        this.damage = damage;
        this.level = level;
    ...
    {
        ProjectileManager.Instance.SpawnProjectile(skillName, damage, level, shotCount, projectileCount, pierceDelay, shotDelay);
    }
